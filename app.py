...
st.markdown("""
이 프로그램은 지구과학 II 천문 단원의 핵심 개념인 "성간 소광"과 "성간 적색화"가 별의 관측 등급 및 거리 측정에 미치는 영향을 실시간으로 시각화합니다.

### 🔍 왜 이런 현상이 나타날까요? (물리적 원리)
우주 공간의 "성간 티끌"은 빛을 흡수하거나 사방으로 흩어지게 만드는 "산란" 현상을 일으킵니다. 
이때 파장이 긴 붉은빛보다 파장이 짧은 푸른빛이 훨씬 더 강하게 산란됩니다. 
